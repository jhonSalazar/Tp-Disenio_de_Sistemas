...
public class ActuadorSensorPersistenciaTest {
	...
	public void test() {
		...
		Condicion condicionReucperada2 = reglaRecuperada2.getCondiciones().get(0);
		
		int valorEsperado = 6;
		
		assertEquals(valorEsperado, condicionReucperada2.getValorDerecha());
	}
