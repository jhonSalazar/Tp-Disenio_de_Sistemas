...
public class CasoDePrueba1 {
	...
	public void InsertarCliente(){
		...
		+" Esta en la zona latitud= "+ transformadorRecuperadoZona1.getLatitud() 
		+" Longitud= "+ transformadorRecuperadoZona1.getLongitud());
		...
		+" Esta en la nueva zona latitud= "+ transformadorRecuperadoZona2.getLatitud() 
		+" Longitud= "+ transformadorRecuperadoZona2.getLongitud());
